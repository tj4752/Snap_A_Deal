...
public class OfferRealmProxy extends com.domain.apps.snapadeal.classes.Offer
    ...
    private ProxyState<com.domain.apps.snapadeal.classes.Offer> proxyState;
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.domain.apps.snapadeal.classes.Offer>(this);
    ...
    @Override
    public com.domain.apps.snapadeal.classes.Currency realmGet$currency() {
        proxyState.getRealm$realm().checkIfValid();
        if (proxyState.getRow$realm().isNullLink(columnInfo.currencyIndex)) {
            return null;
        }
        return proxyState.getRealm$realm().get(com.domain.apps.snapadeal.classes.Currency.class, proxyState.getRow$realm().getLink(columnInfo.currencyIndex), false, Collections.<String>emptyList());
    }

    @Override
    public void realmSet$currency(com.domain.apps.snapadeal.classes.Currency value) {
        if (proxyState.isUnderConstruction()) {
    ...
    @SuppressWarnings("cast")
    public static com.domain.apps.snapadeal.classes.Offer createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = new ArrayList<String>(2);
        com.domain.apps.snapadeal.classes.Offer obj = null;
        if (update) {
            Table table = realm.getTable(com.domain.apps.snapadeal.classes.Offer.class);
            OfferColumnInfo columnInfo = (OfferColumnInfo) realm.getSchema().getColumnInfo(com.domain.apps.snapadeal.classes.Offer.class);
            ...
            if (rowIndex != Table.NO_MATCH) {
                ...
                try {
                    objectContext.set(realm, table.getUncheckedRow(rowIndex), realm.getSchema().getColumnInfo(com.domain.apps.snapadeal.classes.Offer.class), false, Collections.<String> emptyList());
        ...
        if (obj == null) {
            ...
            if (json.has("id")) {
                if (json.isNull("id")) {
                    obj = (io.realm.OfferRealmProxy) realm.createObjectInternal(com.domain.apps.snapadeal.classes.Offer.class, null, true, excludeFields);
                } else {
                    obj = (io.realm.OfferRealmProxy) realm.createObjectInternal(com.domain.apps.snapadeal.classes.Offer.class, json.getInt("id"), true, excludeFields);
                }
            } else {
        ...
        if (json.has("currency")) {
            if (json.isNull("currency")) {
                ...
                com.domain.apps.snapadeal.classes.Currency currencyObj = CurrencyRealmProxy.createOrUpdateUsingJsonObject(realm, json.getJSONObject("currency"), update);
    ...
    public static com.domain.apps.snapadeal.classes.Offer createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        boolean jsonHasPrimaryKey = false;
        final com.domain.apps.snapadeal.classes.Offer obj = new com.domain.apps.snapadeal.classes.Offer();
        final OfferRealmProxyInterface objProxy = (OfferRealmProxyInterface) obj;
        reader.beginObject();
        while (reader.hasNext()) {
            ...
            if (false) {
                ...
                if (reader.peek() == JsonToken.NULL) {
                    ...
                    com.domain.apps.snapadeal.classes.Currency currencyObj = CurrencyRealmProxy.createUsingJsonStream(realm, reader);
                    objProxy.realmSet$currency(currencyObj);
                }
    ...
    public static com.domain.apps.snapadeal.classes.Offer copyOrUpdate(Realm realm, com.domain.apps.snapadeal.classes.Offer object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (com.domain.apps.snapadeal.classes.Offer) cachedRealmObject;
        }

        com.domain.apps.snapadeal.classes.Offer realmObject = null;
    ...
    public static com.domain.apps.snapadeal.classes.Offer copy(Realm realm, com.domain.apps.snapadeal.classes.Offer newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        com.domain.apps.snapadeal.classes.Offer realmObject = realm.createObjectInternal(com.domain.apps.snapadeal.classes.Offer.class, ((OfferRealmProxyInterface) newObject).realmGet$id(), false, Collections.<String>emptyList());
        ...
        com.domain.apps.snapadeal.classes.Currency currencyObj = realmObjectSource.realmGet$currency();
        if (currencyObj == null) {
            realmObjectCopy.realmSet$currency(null);
        } else {
            com.domain.apps.snapadeal.classes.Currency cachecurrency = (com.domain.apps.snapadeal.classes.Currency) cache.get(currencyObj);
    ...
    public static long insert(Realm realm, com.domain.apps.snapadeal.classes.Offer object, Map<RealmModel,Long> cache) {
        ...
        com.domain.apps.snapadeal.classes.Currency currencyObj = ((OfferRealmProxyInterface) object).realmGet$currency();
        if (currencyObj != null) {
        ...
        com.domain.apps.snapadeal.classes.Images imagesObj = ((OfferRealmProxyInterface) object).realmGet$images();
        if (imagesObj != null) {
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        OfferColumnInfo columnInfo = (OfferColumnInfo) realm.getSchema().getColumnInfo(com.domain.apps.snapadeal.classes.Offer.class);
        long pkColumnIndex = columnInfo.idIndex;
        com.domain.apps.snapadeal.classes.Offer object = null;
        while (objects.hasNext()) {
            object = (com.domain.apps.snapadeal.classes.Offer) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.domain.apps.snapadeal.classes.Offer object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.domain.apps.snapadeal.classes.Offer.class);
    ...
    public static com.domain.apps.snapadeal.classes.Offer createDetachedCopy(com.domain.apps.snapadeal.classes.Offer realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.domain.apps.snapadeal.classes.Offer unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.domain.apps.snapadeal.classes.Offer();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.domain.apps.snapadeal.classes.Offer) cachedObject.object;
            }
            unmanagedObject = (com.domain.apps.snapadeal.classes.Offer) cachedObject.object;
    ...
    static com.domain.apps.snapadeal.classes.Offer update(Realm realm, com.domain.apps.snapadeal.classes.Offer realmObject, com.domain.apps.snapadeal.classes.Offer newObject, Map<RealmModel, RealmObjectProxy> cache) {
