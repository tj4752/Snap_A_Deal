...
public class DiscussionRealmProxy extends com.domain.apps.snapadeal.classes.Discussion
    ...
    private ProxyState<com.domain.apps.snapadeal.classes.Discussion> proxyState;
    private RealmList<com.domain.apps.snapadeal.classes.Message> messagesRealmList;
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.domain.apps.snapadeal.classes.Discussion>(this);
    ...
    public com.domain.apps.snapadeal.classes.User realmGet$senderUser() {
        ...
        return proxyState.getRealm$realm().get(com.domain.apps.snapadeal.classes.User.class, proxyState.getRow$realm().getLink(columnInfo.senderUserIndex), false, Collections.<String>emptyList());
    }
    ...
    public RealmList<com.domain.apps.snapadeal.classes.Message> realmGet$messages() {
        ...
        if (messagesRealmList != null) {
            ...
            messagesRealmList = new RealmList<com.domain.apps.snapadeal.classes.Message>(com.domain.apps.snapadeal.classes.Message.class, osList, proxyState.getRealm$realm());
            return messagesRealmList;
        }
    }
    ...
    public void realmSet$messages(RealmList<com.domain.apps.snapadeal.classes.Message> value) {
        if (proxyState.isUnderConstruction()) {
            ...
            if (value != null && !value.isManaged()) {
                ...
                final RealmList<com.domain.apps.snapadeal.classes.Message> original = value;
                value = new RealmList<com.domain.apps.snapadeal.classes.Message>();
                for (com.domain.apps.snapadeal.classes.Message item : original) {
        ...
        if (value != null && value.size() == osList.size()) {
            ...
            for (int i = 0; i < objects; i++) {
                com.domain.apps.snapadeal.classes.Message linkedObject = value.get(i);
    ...
    @SuppressWarnings("cast")
    public static com.domain.apps.snapadeal.classes.Discussion createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = new ArrayList<String>(2);
        com.domain.apps.snapadeal.classes.Discussion obj = null;
        if (update) {
            Table table = realm.getTable(com.domain.apps.snapadeal.classes.Discussion.class);
            DiscussionColumnInfo columnInfo = (DiscussionColumnInfo) realm.getSchema().getColumnInfo(com.domain.apps.snapadeal.classes.Discussion.class);
            ...
            if (rowIndex != Table.NO_MATCH) {
                ...
                try {
                    objectContext.set(realm, table.getUncheckedRow(rowIndex), realm.getSchema().getColumnInfo(com.domain.apps.snapadeal.classes.Discussion.class), false, Collections.<String> emptyList());
        ...
        if (obj == null) {
            ...
            if (json.has("discussionId")) {
                if (json.isNull("discussionId")) {
                    obj = (io.realm.DiscussionRealmProxy) realm.createObjectInternal(com.domain.apps.snapadeal.classes.Discussion.class, null, true, excludeFields);
                } else {
                    obj = (io.realm.DiscussionRealmProxy) realm.createObjectInternal(com.domain.apps.snapadeal.classes.Discussion.class, json.getInt("discussionId"), true, excludeFields);
                }
            } else {
        ...
        if (json.has("senderUser")) {
            if (json.isNull("senderUser")) {
                ...
                com.domain.apps.snapadeal.classes.User senderUserObj = UserRealmProxy.createOrUpdateUsingJsonObject(realm, json.getJSONObject("senderUser"), update);
        ...
        if (json.has("messages")) {
            if (json.isNull("messages")) {
                ...
                for (int i = 0; i < array.length(); i++) {
                    com.domain.apps.snapadeal.classes.Message item = MessageRealmProxy.createOrUpdateUsingJsonObject(realm, array.getJSONObject(i), update);
    ...
    public static com.domain.apps.snapadeal.classes.Discussion createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        boolean jsonHasPrimaryKey = false;
        final com.domain.apps.snapadeal.classes.Discussion obj = new com.domain.apps.snapadeal.classes.Discussion();
        final DiscussionRealmProxyInterface objProxy = (DiscussionRealmProxyInterface) obj;
        reader.beginObject();
        while (reader.hasNext()) {
            ...
            if (false) {
                ...
                if (reader.peek() == JsonToken.NULL) {
                    ...
                    com.domain.apps.snapadeal.classes.User senderUserObj = UserRealmProxy.createUsingJsonStream(realm, reader);
                    objProxy.realmSet$senderUser(senderUserObj);
                }
                ...
                if (reader.peek() == JsonToken.NULL) {
                    ...
                    objProxy.realmSet$messages(new RealmList<com.domain.apps.snapadeal.classes.Message>());
                    reader.beginArray();
                    while (reader.hasNext()) {
                        com.domain.apps.snapadeal.classes.Message item = MessageRealmProxy.createUsingJsonStream(realm, reader);
                        objProxy.realmGet$messages().add(item);
                    }
                    reader.endArray();
                }
    ...
    public static com.domain.apps.snapadeal.classes.Discussion copyOrUpdate(Realm realm, com.domain.apps.snapadeal.classes.Discussion object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (com.domain.apps.snapadeal.classes.Discussion) cachedRealmObject;
        }

        com.domain.apps.snapadeal.classes.Discussion realmObject = null;
    ...
    public static com.domain.apps.snapadeal.classes.Discussion copy(Realm realm, com.domain.apps.snapadeal.classes.Discussion newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        com.domain.apps.snapadeal.classes.Discussion realmObject = realm.createObjectInternal(com.domain.apps.snapadeal.classes.Discussion.class, ((DiscussionRealmProxyInterface) newObject).realmGet$discussionId(), false, Collections.<String>emptyList());
        ...
        com.domain.apps.snapadeal.classes.User senderUserObj = realmObjectSource.realmGet$senderUser();
        if (senderUserObj == null) {
            realmObjectCopy.realmSet$senderUser(null);
        } else {
            com.domain.apps.snapadeal.classes.User cachesenderUser = (com.domain.apps.snapadeal.classes.User) cache.get(senderUserObj);
        ...
        RealmList<com.domain.apps.snapadeal.classes.Message> messagesList = realmObjectSource.realmGet$messages();
        if (messagesList != null) {
            RealmList<com.domain.apps.snapadeal.classes.Message> messagesRealmList = realmObjectCopy.realmGet$messages();
            messagesRealmList.clear();
            for (int i = 0; i < messagesList.size(); i++) {
                com.domain.apps.snapadeal.classes.Message messagesItem = messagesList.get(i);
                com.domain.apps.snapadeal.classes.Message cachemessages = (com.domain.apps.snapadeal.classes.Message) cache.get(messagesItem);
    ...
    public static long insert(Realm realm, com.domain.apps.snapadeal.classes.Discussion object, Map<RealmModel,Long> cache) {
        ...
        com.domain.apps.snapadeal.classes.User senderUserObj = ((DiscussionRealmProxyInterface) object).realmGet$senderUser();
        if (senderUserObj != null) {
        ...
        RealmList<com.domain.apps.snapadeal.classes.Message> messagesList = ((DiscussionRealmProxyInterface) object).realmGet$messages();
        if (messagesList != null) {
            OsList messagesOsList = new OsList(table.getUncheckedRow(rowIndex), columnInfo.messagesIndex);
            for (com.domain.apps.snapadeal.classes.Message messagesItem : messagesList) {
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        DiscussionColumnInfo columnInfo = (DiscussionColumnInfo) realm.getSchema().getColumnInfo(com.domain.apps.snapadeal.classes.Discussion.class);
        long pkColumnIndex = columnInfo.discussionIdIndex;
        com.domain.apps.snapadeal.classes.Discussion object = null;
        while (objects.hasNext()) {
            object = (com.domain.apps.snapadeal.classes.Discussion) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.domain.apps.snapadeal.classes.Discussion object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.domain.apps.snapadeal.classes.Discussion.class);
    ...
    public static com.domain.apps.snapadeal.classes.Discussion createDetachedCopy(com.domain.apps.snapadeal.classes.Discussion realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.domain.apps.snapadeal.classes.Discussion unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.domain.apps.snapadeal.classes.Discussion();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.domain.apps.snapadeal.classes.Discussion) cachedObject.object;
            }
            unmanagedObject = (com.domain.apps.snapadeal.classes.Discussion) cachedObject.object;
        ...
        if (currentDepth == maxDepth) {
            ...
            RealmList<com.domain.apps.snapadeal.classes.Message> managedmessagesList = realmSource.realmGet$messages();
            RealmList<com.domain.apps.snapadeal.classes.Message> unmanagedmessagesList = new RealmList<com.domain.apps.snapadeal.classes.Message>();
            unmanagedCopy.realmSet$messages(unmanagedmessagesList);
            int nextDepth = currentDepth + 1;
            int size = managedmessagesList.size();
            for (int i = 0; i < size; i++) {
                com.domain.apps.snapadeal.classes.Message item = MessageRealmProxy.createDetachedCopy(managedmessagesList.get(i), nextDepth, maxDepth, cache);
    ...
    static com.domain.apps.snapadeal.classes.Discussion update(Realm realm, com.domain.apps.snapadeal.classes.Discussion realmObject, com.domain.apps.snapadeal.classes.Discussion newObject, Map<RealmModel, RealmObjectProxy> cache) {
        ...
        RealmList<com.domain.apps.snapadeal.classes.Message> messagesList = realmObjectSource.realmGet$messages();
        RealmList<com.domain.apps.snapadeal.classes.Message> messagesRealmList = realmObjectTarget.realmGet$messages();
