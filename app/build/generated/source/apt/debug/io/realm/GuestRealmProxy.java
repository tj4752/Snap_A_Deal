...
public class GuestRealmProxy extends com.domain.apps.snapadeal.classes.Guest
    ...
    private ProxyState<com.domain.apps.snapadeal.classes.Guest> proxyState;
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.domain.apps.snapadeal.classes.Guest>(this);
    ...
    @SuppressWarnings("cast")
    public static com.domain.apps.snapadeal.classes.Guest createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = Collections.<String> emptyList();
        com.domain.apps.snapadeal.classes.Guest obj = null;
        if (update) {
            Table table = realm.getTable(com.domain.apps.snapadeal.classes.Guest.class);
            GuestColumnInfo columnInfo = (GuestColumnInfo) realm.getSchema().getColumnInfo(com.domain.apps.snapadeal.classes.Guest.class);
            ...
            if (rowIndex != Table.NO_MATCH) {
                ...
                try {
                    objectContext.set(realm, table.getUncheckedRow(rowIndex), realm.getSchema().getColumnInfo(com.domain.apps.snapadeal.classes.Guest.class), false, Collections.<String> emptyList());
        ...
        if (obj == null) {
            if (json.has("id")) {
                if (json.isNull("id")) {
                    obj = (io.realm.GuestRealmProxy) realm.createObjectInternal(com.domain.apps.snapadeal.classes.Guest.class, null, true, excludeFields);
                } else {
                    obj = (io.realm.GuestRealmProxy) realm.createObjectInternal(com.domain.apps.snapadeal.classes.Guest.class, json.getInt("id"), true, excludeFields);
                }
            } else {
    ...
    public static com.domain.apps.snapadeal.classes.Guest createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        boolean jsonHasPrimaryKey = false;
        final com.domain.apps.snapadeal.classes.Guest obj = new com.domain.apps.snapadeal.classes.Guest();
        final GuestRealmProxyInterface objProxy = (GuestRealmProxyInterface) obj;
        reader.beginObject();
    ...
    public static com.domain.apps.snapadeal.classes.Guest copyOrUpdate(Realm realm, com.domain.apps.snapadeal.classes.Guest object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (com.domain.apps.snapadeal.classes.Guest) cachedRealmObject;
        }

        com.domain.apps.snapadeal.classes.Guest realmObject = null;
    ...
    public static com.domain.apps.snapadeal.classes.Guest copy(Realm realm, com.domain.apps.snapadeal.classes.Guest newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        com.domain.apps.snapadeal.classes.Guest realmObject = realm.createObjectInternal(com.domain.apps.snapadeal.classes.Guest.class, ((GuestRealmProxyInterface) newObject).realmGet$id(), false, Collections.<String>emptyList());
    ...
    public static long insert(Realm realm, com.domain.apps.snapadeal.classes.Guest object, Map<RealmModel,Long> cache) {
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        GuestColumnInfo columnInfo = (GuestColumnInfo) realm.getSchema().getColumnInfo(com.domain.apps.snapadeal.classes.Guest.class);
        long pkColumnIndex = columnInfo.idIndex;
        com.domain.apps.snapadeal.classes.Guest object = null;
        while (objects.hasNext()) {
            object = (com.domain.apps.snapadeal.classes.Guest) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.domain.apps.snapadeal.classes.Guest object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.domain.apps.snapadeal.classes.Guest.class);
    ...
    public static com.domain.apps.snapadeal.classes.Guest createDetachedCopy(com.domain.apps.snapadeal.classes.Guest realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.domain.apps.snapadeal.classes.Guest unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.domain.apps.snapadeal.classes.Guest();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.domain.apps.snapadeal.classes.Guest) cachedObject.object;
            }
            unmanagedObject = (com.domain.apps.snapadeal.classes.Guest) cachedObject.object;
    ...
    static com.domain.apps.snapadeal.classes.Guest update(Realm realm, com.domain.apps.snapadeal.classes.Guest realmObject, com.domain.apps.snapadeal.classes.Guest newObject, Map<RealmModel, RealmObjectProxy> cache) {
