...
public class CountriesModelRealmProxy extends com.domain.apps.snapadeal.classes.CountriesModel
    ...
    private ProxyState<com.domain.apps.snapadeal.classes.CountriesModel> proxyState;
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.domain.apps.snapadeal.classes.CountriesModel>(this);
    ...
    @SuppressWarnings("cast")
    public static com.domain.apps.snapadeal.classes.CountriesModel createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = Collections.<String> emptyList();
        com.domain.apps.snapadeal.classes.CountriesModel obj = null;
        if (update) {
            Table table = realm.getTable(com.domain.apps.snapadeal.classes.CountriesModel.class);
            CountriesModelColumnInfo columnInfo = (CountriesModelColumnInfo) realm.getSchema().getColumnInfo(com.domain.apps.snapadeal.classes.CountriesModel.class);
            ...
            if (rowIndex != Table.NO_MATCH) {
                ...
                try {
                    objectContext.set(realm, table.getUncheckedRow(rowIndex), realm.getSchema().getColumnInfo(com.domain.apps.snapadeal.classes.CountriesModel.class), false, Collections.<String> emptyList());
        ...
        if (obj == null) {
            if (json.has("name")) {
                if (json.isNull("name")) {
                    obj = (io.realm.CountriesModelRealmProxy) realm.createObjectInternal(com.domain.apps.snapadeal.classes.CountriesModel.class, null, true, excludeFields);
                } else {
                    obj = (io.realm.CountriesModelRealmProxy) realm.createObjectInternal(com.domain.apps.snapadeal.classes.CountriesModel.class, json.getString("name"), true, excludeFields);
                }
            } else {
    ...
    public static com.domain.apps.snapadeal.classes.CountriesModel createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        boolean jsonHasPrimaryKey = false;
        final com.domain.apps.snapadeal.classes.CountriesModel obj = new com.domain.apps.snapadeal.classes.CountriesModel();
        final CountriesModelRealmProxyInterface objProxy = (CountriesModelRealmProxyInterface) obj;
        reader.beginObject();
    ...
    public static com.domain.apps.snapadeal.classes.CountriesModel copyOrUpdate(Realm realm, com.domain.apps.snapadeal.classes.CountriesModel object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (com.domain.apps.snapadeal.classes.CountriesModel) cachedRealmObject;
        }

        com.domain.apps.snapadeal.classes.CountriesModel realmObject = null;
    ...
    public static com.domain.apps.snapadeal.classes.CountriesModel copy(Realm realm, com.domain.apps.snapadeal.classes.CountriesModel newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        com.domain.apps.snapadeal.classes.CountriesModel realmObject = realm.createObjectInternal(com.domain.apps.snapadeal.classes.CountriesModel.class, ((CountriesModelRealmProxyInterface) newObject).realmGet$name(), false, Collections.<String>emptyList());
    ...
    public static long insert(Realm realm, com.domain.apps.snapadeal.classes.CountriesModel object, Map<RealmModel,Long> cache) {
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        CountriesModelColumnInfo columnInfo = (CountriesModelColumnInfo) realm.getSchema().getColumnInfo(com.domain.apps.snapadeal.classes.CountriesModel.class);
        long pkColumnIndex = columnInfo.nameIndex;
        com.domain.apps.snapadeal.classes.CountriesModel object = null;
        while (objects.hasNext()) {
            object = (com.domain.apps.snapadeal.classes.CountriesModel) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.domain.apps.snapadeal.classes.CountriesModel object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.domain.apps.snapadeal.classes.CountriesModel.class);
    ...
    public static com.domain.apps.snapadeal.classes.CountriesModel createDetachedCopy(com.domain.apps.snapadeal.classes.CountriesModel realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.domain.apps.snapadeal.classes.CountriesModel unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.domain.apps.snapadeal.classes.CountriesModel();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.domain.apps.snapadeal.classes.CountriesModel) cachedObject.object;
            }
            unmanagedObject = (com.domain.apps.snapadeal.classes.CountriesModel) cachedObject.object;
    ...
    static com.domain.apps.snapadeal.classes.CountriesModel update(Realm realm, com.domain.apps.snapadeal.classes.CountriesModel realmObject, com.domain.apps.snapadeal.classes.CountriesModel newObject, Map<RealmModel, RealmObjectProxy> cache) {
