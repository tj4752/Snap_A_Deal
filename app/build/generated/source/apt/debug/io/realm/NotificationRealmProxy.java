...
public class NotificationRealmProxy extends com.domain.apps.snapadeal.classes.Notification
    ...
    private ProxyState<com.domain.apps.snapadeal.classes.Notification> proxyState;
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.domain.apps.snapadeal.classes.Notification>(this);
    ...
    @SuppressWarnings("cast")
    public static com.domain.apps.snapadeal.classes.Notification createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = new ArrayList<String>(1);
        com.domain.apps.snapadeal.classes.Notification obj = null;
        if (update) {
            Table table = realm.getTable(com.domain.apps.snapadeal.classes.Notification.class);
            NotificationColumnInfo columnInfo = (NotificationColumnInfo) realm.getSchema().getColumnInfo(com.domain.apps.snapadeal.classes.Notification.class);
            ...
            if (rowIndex != Table.NO_MATCH) {
                ...
                try {
                    objectContext.set(realm, table.getUncheckedRow(rowIndex), realm.getSchema().getColumnInfo(com.domain.apps.snapadeal.classes.Notification.class), false, Collections.<String> emptyList());
        ...
        if (obj == null) {
            ...
            if (json.has("id")) {
                if (json.isNull("id")) {
                    obj = (io.realm.NotificationRealmProxy) realm.createObjectInternal(com.domain.apps.snapadeal.classes.Notification.class, null, true, excludeFields);
                } else {
                    obj = (io.realm.NotificationRealmProxy) realm.createObjectInternal(com.domain.apps.snapadeal.classes.Notification.class, json.getInt("id"), true, excludeFields);
                }
            } else {
    ...
    public static com.domain.apps.snapadeal.classes.Notification createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        boolean jsonHasPrimaryKey = false;
        final com.domain.apps.snapadeal.classes.Notification obj = new com.domain.apps.snapadeal.classes.Notification();
        final NotificationRealmProxyInterface objProxy = (NotificationRealmProxyInterface) obj;
        reader.beginObject();
    ...
    public static com.domain.apps.snapadeal.classes.Notification copyOrUpdate(Realm realm, com.domain.apps.snapadeal.classes.Notification object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (com.domain.apps.snapadeal.classes.Notification) cachedRealmObject;
        }

        com.domain.apps.snapadeal.classes.Notification realmObject = null;
    ...
    public static com.domain.apps.snapadeal.classes.Notification copy(Realm realm, com.domain.apps.snapadeal.classes.Notification newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        com.domain.apps.snapadeal.classes.Notification realmObject = realm.createObjectInternal(com.domain.apps.snapadeal.classes.Notification.class, ((NotificationRealmProxyInterface) newObject).realmGet$id(), false, Collections.<String>emptyList());
    ...
    public static long insert(Realm realm, com.domain.apps.snapadeal.classes.Notification object, Map<RealmModel,Long> cache) {
        ...
        com.domain.apps.snapadeal.classes.Images imagesObj = ((NotificationRealmProxyInterface) object).realmGet$images();
        if (imagesObj != null) {
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        NotificationColumnInfo columnInfo = (NotificationColumnInfo) realm.getSchema().getColumnInfo(com.domain.apps.snapadeal.classes.Notification.class);
        long pkColumnIndex = columnInfo.idIndex;
        com.domain.apps.snapadeal.classes.Notification object = null;
        while (objects.hasNext()) {
            object = (com.domain.apps.snapadeal.classes.Notification) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.domain.apps.snapadeal.classes.Notification object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.domain.apps.snapadeal.classes.Notification.class);
    ...
    public static com.domain.apps.snapadeal.classes.Notification createDetachedCopy(com.domain.apps.snapadeal.classes.Notification realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.domain.apps.snapadeal.classes.Notification unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.domain.apps.snapadeal.classes.Notification();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.domain.apps.snapadeal.classes.Notification) cachedObject.object;
            }
            unmanagedObject = (com.domain.apps.snapadeal.classes.Notification) cachedObject.object;
    ...
    static com.domain.apps.snapadeal.classes.Notification update(Realm realm, com.domain.apps.snapadeal.classes.Notification realmObject, com.domain.apps.snapadeal.classes.Notification newObject, Map<RealmModel, RealmObjectProxy> cache) {
