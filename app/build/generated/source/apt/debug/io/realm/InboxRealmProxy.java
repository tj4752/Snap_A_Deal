...
public class InboxRealmProxy extends com.domain.apps.snapadeal.classes.Inbox
    ...
    private ProxyState<com.domain.apps.snapadeal.classes.Inbox> proxyState;
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.domain.apps.snapadeal.classes.Inbox>(this);
    ...
    @SuppressWarnings("cast")
    public static com.domain.apps.snapadeal.classes.Inbox createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = new ArrayList<String>(2);
        com.domain.apps.snapadeal.classes.Inbox obj = null;
        if (update) {
            Table table = realm.getTable(com.domain.apps.snapadeal.classes.Inbox.class);
            InboxColumnInfo columnInfo = (InboxColumnInfo) realm.getSchema().getColumnInfo(com.domain.apps.snapadeal.classes.Inbox.class);
            ...
            if (rowIndex != Table.NO_MATCH) {
                ...
                try {
                    objectContext.set(realm, table.getUncheckedRow(rowIndex), realm.getSchema().getColumnInfo(com.domain.apps.snapadeal.classes.Inbox.class), false, Collections.<String> emptyList());
        ...
        if (obj == null) {
            ...
            if (json.has("discussionId")) {
                if (json.isNull("discussionId")) {
                    obj = (io.realm.InboxRealmProxy) realm.createObjectInternal(com.domain.apps.snapadeal.classes.Inbox.class, null, true, excludeFields);
                } else {
                    obj = (io.realm.InboxRealmProxy) realm.createObjectInternal(com.domain.apps.snapadeal.classes.Inbox.class, json.getString("discussionId"), true, excludeFields);
                }
            } else {
    ...
    public static com.domain.apps.snapadeal.classes.Inbox createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        boolean jsonHasPrimaryKey = false;
        final com.domain.apps.snapadeal.classes.Inbox obj = new com.domain.apps.snapadeal.classes.Inbox();
        final InboxRealmProxyInterface objProxy = (InboxRealmProxyInterface) obj;
        reader.beginObject();
    ...
    public static com.domain.apps.snapadeal.classes.Inbox copyOrUpdate(Realm realm, com.domain.apps.snapadeal.classes.Inbox object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (com.domain.apps.snapadeal.classes.Inbox) cachedRealmObject;
        }

        com.domain.apps.snapadeal.classes.Inbox realmObject = null;
    ...
    public static com.domain.apps.snapadeal.classes.Inbox copy(Realm realm, com.domain.apps.snapadeal.classes.Inbox newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        com.domain.apps.snapadeal.classes.Inbox realmObject = realm.createObjectInternal(com.domain.apps.snapadeal.classes.Inbox.class, ((InboxRealmProxyInterface) newObject).realmGet$discussionId(), false, Collections.<String>emptyList());
    ...
    public static long insert(Realm realm, com.domain.apps.snapadeal.classes.Inbox object, Map<RealmModel,Long> cache) {
        ...
        com.domain.apps.snapadeal.classes.User senderUserObj = ((InboxRealmProxyInterface) object).realmGet$senderUser();
        if (senderUserObj != null) {
        ...
        RealmList<com.domain.apps.snapadeal.classes.Message> messagesList = ((InboxRealmProxyInterface) object).realmGet$messages();
        if (messagesList != null) {
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        InboxColumnInfo columnInfo = (InboxColumnInfo) realm.getSchema().getColumnInfo(com.domain.apps.snapadeal.classes.Inbox.class);
        long pkColumnIndex = columnInfo.discussionIdIndex;
        com.domain.apps.snapadeal.classes.Inbox object = null;
        while (objects.hasNext()) {
            object = (com.domain.apps.snapadeal.classes.Inbox) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.domain.apps.snapadeal.classes.Inbox object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.domain.apps.snapadeal.classes.Inbox.class);
    ...
    public static com.domain.apps.snapadeal.classes.Inbox createDetachedCopy(com.domain.apps.snapadeal.classes.Inbox realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.domain.apps.snapadeal.classes.Inbox unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.domain.apps.snapadeal.classes.Inbox();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.domain.apps.snapadeal.classes.Inbox) cachedObject.object;
            }
            unmanagedObject = (com.domain.apps.snapadeal.classes.Inbox) cachedObject.object;
    ...
    static com.domain.apps.snapadeal.classes.Inbox update(Realm realm, com.domain.apps.snapadeal.classes.Inbox realmObject, com.domain.apps.snapadeal.classes.Inbox newObject, Map<RealmModel, RealmObjectProxy> cache) {
