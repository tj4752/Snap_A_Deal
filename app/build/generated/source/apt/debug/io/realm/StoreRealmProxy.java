...
public class StoreRealmProxy extends com.domain.apps.snapadeal.classes.Store
    ...
    private ProxyState<com.domain.apps.snapadeal.classes.Store> proxyState;
    private RealmList<com.domain.apps.snapadeal.classes.Images> listImagesRealmList;
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.domain.apps.snapadeal.classes.Store>(this);
    ...
    public com.domain.apps.snapadeal.classes.User realmGet$user() {
        ...
        return proxyState.getRealm$realm().get(com.domain.apps.snapadeal.classes.User.class, proxyState.getRow$realm().getLink(columnInfo.userIndex), false, Collections.<String>emptyList());
    }
    ...
    public RealmList<com.domain.apps.snapadeal.classes.Images> realmGet$listImages() {
        ...
        if (listImagesRealmList != null) {
            ...
            listImagesRealmList = new RealmList<com.domain.apps.snapadeal.classes.Images>(com.domain.apps.snapadeal.classes.Images.class, osList, proxyState.getRealm$realm());
            return listImagesRealmList;
        }
    }
    ...
    public void realmSet$listImages(RealmList<com.domain.apps.snapadeal.classes.Images> value) {
        if (proxyState.isUnderConstruction()) {
            ...
            if (value != null && !value.isManaged()) {
                ...
                final RealmList<com.domain.apps.snapadeal.classes.Images> original = value;
                value = new RealmList<com.domain.apps.snapadeal.classes.Images>();
                for (com.domain.apps.snapadeal.classes.Images item : original) {
        ...
        if (value != null && value.size() == osList.size()) {
            ...
            for (int i = 0; i < objects; i++) {
                com.domain.apps.snapadeal.classes.Images linkedObject = value.get(i);
    ...
    @SuppressWarnings("cast")
    public static com.domain.apps.snapadeal.classes.Store createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = new ArrayList<String>(3);
        com.domain.apps.snapadeal.classes.Store obj = null;
        if (update) {
            Table table = realm.getTable(com.domain.apps.snapadeal.classes.Store.class);
            StoreColumnInfo columnInfo = (StoreColumnInfo) realm.getSchema().getColumnInfo(com.domain.apps.snapadeal.classes.Store.class);
            ...
            if (rowIndex != Table.NO_MATCH) {
                ...
                try {
                    objectContext.set(realm, table.getUncheckedRow(rowIndex), realm.getSchema().getColumnInfo(com.domain.apps.snapadeal.classes.Store.class), false, Collections.<String> emptyList());
        ...
        if (obj == null) {
            ...
            if (json.has("id")) {
                if (json.isNull("id")) {
                    obj = (io.realm.StoreRealmProxy) realm.createObjectInternal(com.domain.apps.snapadeal.classes.Store.class, null, true, excludeFields);
                } else {
                    obj = (io.realm.StoreRealmProxy) realm.createObjectInternal(com.domain.apps.snapadeal.classes.Store.class, json.getInt("id"), true, excludeFields);
                }
            } else {
        ...
        if (json.has("user")) {
            if (json.isNull("user")) {
                ...
                com.domain.apps.snapadeal.classes.User userObj = UserRealmProxy.createOrUpdateUsingJsonObject(realm, json.getJSONObject("user"), update);
        ...
        if (json.has("listImages")) {
            if (json.isNull("listImages")) {
                ...
                for (int i = 0; i < array.length(); i++) {
                    com.domain.apps.snapadeal.classes.Images item = ImagesRealmProxy.createOrUpdateUsingJsonObject(realm, array.getJSONObject(i), update);
    ...
    public static com.domain.apps.snapadeal.classes.Store createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        boolean jsonHasPrimaryKey = false;
        final com.domain.apps.snapadeal.classes.Store obj = new com.domain.apps.snapadeal.classes.Store();
        final StoreRealmProxyInterface objProxy = (StoreRealmProxyInterface) obj;
        reader.beginObject();
        while (reader.hasNext()) {
            ...
            if (false) {
                ...
                if (reader.peek() == JsonToken.NULL) {
                    ...
                    com.domain.apps.snapadeal.classes.User userObj = UserRealmProxy.createUsingJsonStream(realm, reader);
                    objProxy.realmSet$user(userObj);
                }
                ...
                if (reader.peek() == JsonToken.NULL) {
                    ...
                    objProxy.realmSet$listImages(new RealmList<com.domain.apps.snapadeal.classes.Images>());
                    reader.beginArray();
                    while (reader.hasNext()) {
                        com.domain.apps.snapadeal.classes.Images item = ImagesRealmProxy.createUsingJsonStream(realm, reader);
                        objProxy.realmGet$listImages().add(item);
                    }
                    reader.endArray();
                }
    ...
    public static com.domain.apps.snapadeal.classes.Store copyOrUpdate(Realm realm, com.domain.apps.snapadeal.classes.Store object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (com.domain.apps.snapadeal.classes.Store) cachedRealmObject;
        }

        com.domain.apps.snapadeal.classes.Store realmObject = null;
    ...
    public static com.domain.apps.snapadeal.classes.Store copy(Realm realm, com.domain.apps.snapadeal.classes.Store newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        com.domain.apps.snapadeal.classes.Store realmObject = realm.createObjectInternal(com.domain.apps.snapadeal.classes.Store.class, ((StoreRealmProxyInterface) newObject).realmGet$id(), false, Collections.<String>emptyList());
        ...
        com.domain.apps.snapadeal.classes.User userObj = realmObjectSource.realmGet$user();
        if (userObj == null) {
            realmObjectCopy.realmSet$user(null);
        } else {
            com.domain.apps.snapadeal.classes.User cacheuser = (com.domain.apps.snapadeal.classes.User) cache.get(userObj);
            if (cacheuser != null) {
        ...
        RealmList<com.domain.apps.snapadeal.classes.Images> listImagesList = realmObjectSource.realmGet$listImages();
        if (listImagesList != null) {
            RealmList<com.domain.apps.snapadeal.classes.Images> listImagesRealmList = realmObjectCopy.realmGet$listImages();
            listImagesRealmList.clear();
            for (int i = 0; i < listImagesList.size(); i++) {
                com.domain.apps.snapadeal.classes.Images listImagesItem = listImagesList.get(i);
                com.domain.apps.snapadeal.classes.Images cachelistImages = (com.domain.apps.snapadeal.classes.Images) cache.get(listImagesItem);
    ...
    public static long insert(Realm realm, com.domain.apps.snapadeal.classes.Store object, Map<RealmModel,Long> cache) {
        ...
        com.domain.apps.snapadeal.classes.Images imagesObj = ((StoreRealmProxyInterface) object).realmGet$images();
        if (imagesObj != null) {
        ...
        com.domain.apps.snapadeal.classes.User userObj = ((StoreRealmProxyInterface) object).realmGet$user();
        if (userObj != null) {
        ...
        RealmList<com.domain.apps.snapadeal.classes.Images> listImagesList = ((StoreRealmProxyInterface) object).realmGet$listImages();
        if (listImagesList != null) {
            OsList listImagesOsList = new OsList(table.getUncheckedRow(rowIndex), columnInfo.listImagesIndex);
            for (com.domain.apps.snapadeal.classes.Images listImagesItem : listImagesList) {
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        StoreColumnInfo columnInfo = (StoreColumnInfo) realm.getSchema().getColumnInfo(com.domain.apps.snapadeal.classes.Store.class);
        long pkColumnIndex = columnInfo.idIndex;
        com.domain.apps.snapadeal.classes.Store object = null;
        while (objects.hasNext()) {
            object = (com.domain.apps.snapadeal.classes.Store) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.domain.apps.snapadeal.classes.Store object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.domain.apps.snapadeal.classes.Store.class);
    ...
    public static com.domain.apps.snapadeal.classes.Store createDetachedCopy(com.domain.apps.snapadeal.classes.Store realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.domain.apps.snapadeal.classes.Store unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.domain.apps.snapadeal.classes.Store();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.domain.apps.snapadeal.classes.Store) cachedObject.object;
            }
            unmanagedObject = (com.domain.apps.snapadeal.classes.Store) cachedObject.object;
        ...
        if (currentDepth == maxDepth) {
            ...
            RealmList<com.domain.apps.snapadeal.classes.Images> managedlistImagesList = realmSource.realmGet$listImages();
            RealmList<com.domain.apps.snapadeal.classes.Images> unmanagedlistImagesList = new RealmList<com.domain.apps.snapadeal.classes.Images>();
            unmanagedCopy.realmSet$listImages(unmanagedlistImagesList);
            int nextDepth = currentDepth + 1;
            int size = managedlistImagesList.size();
            for (int i = 0; i < size; i++) {
                com.domain.apps.snapadeal.classes.Images item = ImagesRealmProxy.createDetachedCopy(managedlistImagesList.get(i), nextDepth, maxDepth, cache);
    ...
    static com.domain.apps.snapadeal.classes.Store update(Realm realm, com.domain.apps.snapadeal.classes.Store realmObject, com.domain.apps.snapadeal.classes.Store newObject, Map<RealmModel, RealmObjectProxy> cache) {
        ...
        RealmList<com.domain.apps.snapadeal.classes.Images> listImagesList = realmObjectSource.realmGet$listImages();
        RealmList<com.domain.apps.snapadeal.classes.Images> listImagesRealmList = realmObjectTarget.realmGet$listImages();
