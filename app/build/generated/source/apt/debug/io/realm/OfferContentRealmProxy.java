...
public class OfferContentRealmProxy extends com.domain.apps.snapadeal.classes.OfferContent
    ...
    private ProxyState<com.domain.apps.snapadeal.classes.OfferContent> proxyState;
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.domain.apps.snapadeal.classes.OfferContent>(this);
    ...
    @SuppressWarnings("cast")
    public static com.domain.apps.snapadeal.classes.OfferContent createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = Collections.<String> emptyList();
        com.domain.apps.snapadeal.classes.OfferContent obj = null;
        if (update) {
            Table table = realm.getTable(com.domain.apps.snapadeal.classes.OfferContent.class);
            OfferContentColumnInfo columnInfo = (OfferContentColumnInfo) realm.getSchema().getColumnInfo(com.domain.apps.snapadeal.classes.OfferContent.class);
            ...
            if (rowIndex != Table.NO_MATCH) {
                ...
                try {
                    objectContext.set(realm, table.getUncheckedRow(rowIndex), realm.getSchema().getColumnInfo(com.domain.apps.snapadeal.classes.OfferContent.class), false, Collections.<String> emptyList());
        ...
        if (obj == null) {
            if (json.has("id")) {
                if (json.isNull("id")) {
                    obj = (io.realm.OfferContentRealmProxy) realm.createObjectInternal(com.domain.apps.snapadeal.classes.OfferContent.class, null, true, excludeFields);
                } else {
                    obj = (io.realm.OfferContentRealmProxy) realm.createObjectInternal(com.domain.apps.snapadeal.classes.OfferContent.class, json.getInt("id"), true, excludeFields);
                }
            } else {
    ...
    public static com.domain.apps.snapadeal.classes.OfferContent createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        boolean jsonHasPrimaryKey = false;
        final com.domain.apps.snapadeal.classes.OfferContent obj = new com.domain.apps.snapadeal.classes.OfferContent();
        final OfferContentRealmProxyInterface objProxy = (OfferContentRealmProxyInterface) obj;
        reader.beginObject();
    ...
    public static com.domain.apps.snapadeal.classes.OfferContent copyOrUpdate(Realm realm, com.domain.apps.snapadeal.classes.OfferContent object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (com.domain.apps.snapadeal.classes.OfferContent) cachedRealmObject;
        }

        com.domain.apps.snapadeal.classes.OfferContent realmObject = null;
    ...
    public static com.domain.apps.snapadeal.classes.OfferContent copy(Realm realm, com.domain.apps.snapadeal.classes.OfferContent newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        com.domain.apps.snapadeal.classes.OfferContent realmObject = realm.createObjectInternal(com.domain.apps.snapadeal.classes.OfferContent.class, ((OfferContentRealmProxyInterface) newObject).realmGet$id(), false, Collections.<String>emptyList());
    ...
    public static long insert(Realm realm, com.domain.apps.snapadeal.classes.OfferContent object, Map<RealmModel,Long> cache) {
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        OfferContentColumnInfo columnInfo = (OfferContentColumnInfo) realm.getSchema().getColumnInfo(com.domain.apps.snapadeal.classes.OfferContent.class);
        long pkColumnIndex = columnInfo.idIndex;
        com.domain.apps.snapadeal.classes.OfferContent object = null;
        while (objects.hasNext()) {
            object = (com.domain.apps.snapadeal.classes.OfferContent) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.domain.apps.snapadeal.classes.OfferContent object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.domain.apps.snapadeal.classes.OfferContent.class);
    ...
    public static com.domain.apps.snapadeal.classes.OfferContent createDetachedCopy(com.domain.apps.snapadeal.classes.OfferContent realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.domain.apps.snapadeal.classes.OfferContent unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.domain.apps.snapadeal.classes.OfferContent();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.domain.apps.snapadeal.classes.OfferContent) cachedObject.object;
            }
            unmanagedObject = (com.domain.apps.snapadeal.classes.OfferContent) cachedObject.object;
    ...
    static com.domain.apps.snapadeal.classes.OfferContent update(Realm realm, com.domain.apps.snapadeal.classes.OfferContent realmObject, com.domain.apps.snapadeal.classes.OfferContent newObject, Map<RealmModel, RealmObjectProxy> cache) {
